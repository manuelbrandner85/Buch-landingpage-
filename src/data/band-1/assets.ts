...
export const ASSETS_BAND_1: Asset[] = [
  ...
  { id: 'catalhoeyuek-innen', datei: 'catal', breite: 1200, hoehe: 684, herkunft: 'Freie Rekonstruktion',
  ...
  { id: 'wechselstation', datei: 'persien', breite: 1920, hoehe: 1080, herkunft: 'Freie Rekonstruktion',
    ...
    referenzFuer: 'susa' },
  { id: 'roemische-strasse', datei: 'strasse', breite: 1200, hoehe: 741, herkunft: 'Freie Rekonstruktion',
  ...
  { id: 'kapitel-2-auftakt', datei: 'kap2', breite: 1200, hoehe: 1240, herkunft: 'Freie Rekonstruktion',
    alt: 'Reifes Ährenfeld auf einem Hang im Abendlicht.' },
  { id: 'kapitel-3-auftakt', datei: 'kap3', breite: 1200, hoehe: 1240, herkunft: 'Freie Rekonstruktion',
    alt: 'Eine Zikkurat mit breiter Treppe vor weitem Himmel.' },
  { id: 'kapitel-4-auftakt', datei: 'kap4', breite: 1200, hoehe: 1240, herkunft: 'Freie Rekonstruktion',
    alt: 'Ein Torbau aus Säulen und Steinquadern auf einer Anhöhe.' },
  { id: 'kapitel-6-auftakt', datei: 'kap6', breite: 1200, hoehe: 1240, herkunft: 'Freie Rekonstruktion',
  ...
  { id: 'bibliothek', datei: 'bibliothek', breite: 1000, hoehe: 1278, herkunft: 'Freie Rekonstruktion',
    alt: 'Regale voller Tontafeln in einer Kammer; eine Gestalt hebt eine Tafel ans Licht.',
    referenzFuer: 'ninive' },
  { id: 'baustelle', datei: 'baustelle', breite: 1200, hoehe: 879, herkunft: 'Freie Rekonstruktion',
