...
export const ASSETS_BAND_2: Asset[] = [
  ...
  { id: 'cover-band-2', bandId: 'band-2', datei: 'cover-band-2',
    breite: 1200, hoehe: 1800, herkunft: 'Eigene Darstellung',
    alt: 'Umschlag von Band 2: Glaube, Gold und Revolution – nächtlicher Hafen, ein Goldfaden führt durch die Gasse zum Tor.' },
